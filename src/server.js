...
const shutdown = async signal => {
  ...
  runtime.stockTokens.worker.stop();
  server.close(async () => { await runtime.stockTokens.repository.close(); await runtime.discovery.repository.close(); await runtime.store.close(); process.exit(0); });
};
